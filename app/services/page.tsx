    ...
    return(
        <main>
            ...
            <section className="w-full pt-5 pb-10 lg:py-10 px-7 lg:px-10 h-[270px] lg:h-[400px]">
                ...
                <h1 className="text-white text-[23px] lg:text-[67px] font-bold absolute top-[90px] lg:top-[150px]">Nossos Serviços</h1>
                <p className="text-left text-[12px] lg:text-[22px] lg:max-w-[870px] text-[#D8D8D8] mt-2 absolute top-[130px] mr-7 lg:top-[245px]">Soluções completas em arquitetura, engenharia e automação para transformar seus espaços com excelência técnica e cuidado personalizado.</p>
            ...
            {/* SERVIÇOS */}
            <section className="w-full min-h-screen bg-[#0B0E10] py-10 lg:py-10 px-7 lg:px-10 flex flex-col justify-center items-center gap-14">
