...
export function PrimaryCard({title, text, item1, item2, item3, imageSrc, imageAlt}: CardProps) {
    return (
        <article style={{ height: `${280}px`, width: `${175}px` }} className=" bg-[#0B0E10] text-black rounded-xl border border-[#424242] relative">
...
export function SecondaryCard({title, text, item1, item2, item3, imageSrc, imageAlt}: CardProps) {
    return (
        <article style={{ height: `${220}px`, width: `${150}px` }} className="relative bg-[#0B0E10] text-black rounded-xl border border-[#424242]">
