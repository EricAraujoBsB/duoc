...
export function HistoryCard({title, text}: HistoryCardProps) {
    return(
        <article className="p-2.5 ring-[0.15px] ring-[#D8D8D8] bg-[#0E1011] w-[142px] lg:w-[250px] rounded-sm">
...
export function ValueCard({title, text, imgSrc, imgAlt, mobileImgWidth, mobileImgHeight, dekstopImgWidth, dekstopImgHeight}: ValueCardProps) {
    return(
        <article className="p-2.5 lg:p-7 ring-[0.15px] ring-[#D8D8D8] bg-[#0E1011] rounded-sm w-[142px] lg:w-[325px] h-[100px] lg:h-[185px]">
